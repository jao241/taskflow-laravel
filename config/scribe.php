...
return [
    ...
    'description' => 'API documentation for the TaskFlow application. This documentation provides all the information you need to work with our API, including endpoint details, request and response examples.',
    ...
    'auth' => [
        ...
        'extra_info' => 'You need to add another user if you forgoten your token.',
    ],
